...
Первый рабочий деплой на BlueStacks — 2026-07-25, билд на тот момент **v1.9.43** (= v1.9.42 + реклама выключена флагом, см. [[billing8-ads]]; актуальную версию смотреть в `buildozer.spec`, не здесь). 1.9.40/1.9.41 без шима — на BlueStacks падают на старте, на реальном железе должны работать.
...
Девайс-чеклист из [[billing8-ads]] теперь частично прогоняем на Player 2 (Play-сервисы есть, но аккаунт в свежем инстансе не залогинен — для purchase/restore нужен вход в Google).
