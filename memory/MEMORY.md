...
- [Качество UI-переводов](i18n/i18n-ui-quality.md) — XX.json был выводом Google Translate на 93–95%; гейт + глоссарий; ВСЕ 7 языков перечинены (последние 6 — волной 2026-08-03: 114 батчей, слепая приёмка, калибровка)
